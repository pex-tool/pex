...
class SourceTranslator(TranslatorBase):
  ...
  def __init__(self,
               ...
               supported_tags=Platform.current().supported_tags(),
               use_2to3=False,
...
class BinaryTranslator(TranslatorBase):
  def __init__(self,
    ...
    self._supported_tags = supported_tags or Platform.current().supported_tags()
...
class Translator(object):
  ...
  def default(interpreter=None, supported_tags=None):
    ...
    supported_tags = supported_tags or Platform.current().supported_tags()
