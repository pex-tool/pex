...
class PipVersion(Enum["PipVersionValue"]):
    ...
    DEFAULT = DefaultPipVersion(
        preferred=(
            ...
            v26_1,  # First with 3.10 lower bound.
        )
    )
