...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.distlib.scripts import ScriptMaker  # vendor:skip
else:
  from pex.third_party.pip._vendor.distlib.scripts import ScriptMaker
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six import StringIO  # vendor:skip
else:
  from pex.third_party.pip._vendor.six import StringIO


if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal import pep425tags  # vendor:skip
else:
  from pex.third_party.pip._internal import pep425tags

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.download import unpack_url  # vendor:skip
else:
  from pex.third_party.pip._internal.download import unpack_url
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.locations import distutils_scheme  # vendor:skip
else:
  from pex.third_party.pip._internal.locations import distutils_scheme
...
if MYPY_CHECK_RUNNING:
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.index import FormatControl, PackageFinder  # vendor:skip
    else:
      from pex.third_party.pip._internal.index import FormatControl, PackageFinder
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      ...
      from pex.third_party.pip._internal.operations.prepare import (
        RequirementPreparer
    )
