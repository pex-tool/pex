...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six import text_type  # vendor:skip
else:
  from pex.third_party.pip._vendor.six import text_type

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.urllib3.util import IS_PYOPENSSL  # vendor:skip
else:
  from pex.third_party.pip._vendor.urllib3.util import IS_PYOPENSSL
...
try:
    ...
    try:
        if "__PEX_UNVENDORED__" in __import__("os").environ:
          from pip._vendor import ipaddress  # vendor:skip
        else:
          from pex.third_party.pip._vendor import ipaddress
  # type: ignore
    except ImportError:
