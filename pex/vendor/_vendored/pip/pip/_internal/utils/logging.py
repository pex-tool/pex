...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six import PY2  # vendor:skip
else:
  from pex.third_party.pip._vendor.six import PY2
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.deprecation import DEPRECATION_MSG_PREFIX  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.deprecation import DEPRECATION_MSG_PREFIX

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.misc import ensure_dir, subprocess_logger  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.misc import ensure_dir, subprocess_logger
...
try:
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._vendor import colorama as _colorama  # vendor:skip
    else:
      from pex.third_party.pip._vendor import colorama as _colorama
...
# ImportError.
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._vendor.colorama import Fore  # vendor:skip
    else:
      from pex.third_party.pip._vendor.colorama import Fore
