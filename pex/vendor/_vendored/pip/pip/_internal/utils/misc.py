...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.retrying import retry  # vendor:skip
else:
  from pex.third_party.pip._vendor.retrying import retry
  # type: ignore
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six import PY2, text_type  # vendor:skip
else:
  from pex.third_party.pip._vendor.six import PY2, text_type

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six.moves import input, shlex_quote  # vendor:skip
else:
  from pex.third_party.pip._vendor.six.moves import input, shlex_quote
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.six.moves.urllib.parse import unquote as urllib_unquote  # vendor:skip
else:
  from pex.third_party.pip._vendor.six.moves.urllib.parse import unquote as urllib_unquote


if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip import __version__  # vendor:skip
else:
  from pex.third_party.pip import __version__

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.exceptions import CommandError, InstallationError  # vendor:skip
else:
  from pex.third_party.pip._internal.exceptions import CommandError, InstallationError

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.locations import site_packages, user_site  # vendor:skip
else:
  from pex.third_party.pip._internal.locations import site_packages, user_site
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  ...
  from pex.third_party.pip._internal.utils.compat import (
    WINDOWS, console_to_str, expanduser, stdlib_pkgs, str_to_display,
)
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  ...
  from pex.third_party.pip._internal.utils.virtualenv import (
    running_under_virtualenv, virtualenv_no_global,
)
...
if MYPY_CHECK_RUNNING:
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.utils.ui import SpinnerInterface  # vendor:skip
    else:
      from pex.third_party.pip._internal.utils.ui import SpinnerInterface
...
def unpack_file(
    ...
    if (content_type == 'application/zip' or
        ...
        if "__PEX_UNVENDORED__" in __import__("os").environ:
          from pip._internal.vcs.subversion import Subversion  # vendor:skip
        else:
          from pex.third_party.pip._internal.vcs.subversion import Subversion
