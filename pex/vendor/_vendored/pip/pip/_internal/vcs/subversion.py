...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.vcs.versioncontrol import VersionControl, vcs  # vendor:skip
else:
  from pex.third_party.pip._internal.vcs.versioncontrol import VersionControl, vcs
...
if MYPY_CHECK_RUNNING:
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.vcs.versioncontrol import RevOptions  # vendor:skip
    else:
      from pex.third_party.pip._internal.vcs.versioncontrol import RevOptions
