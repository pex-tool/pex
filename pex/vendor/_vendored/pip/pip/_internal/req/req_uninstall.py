...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.exceptions import UninstallationError  # vendor:skip
else:
  from pex.third_party.pip._internal.exceptions import UninstallationError

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.locations import bin_py, bin_user  # vendor:skip
else:
  from pex.third_party.pip._internal.locations import bin_py, bin_user

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.compat import WINDOWS, cache_from_source, uses_pycache  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.compat import WINDOWS, cache_from_source, uses_pycache
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.temp_dir import AdjacentTempDirectory, TempDirectory  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.temp_dir import AdjacentTempDirectory, TempDirectory
