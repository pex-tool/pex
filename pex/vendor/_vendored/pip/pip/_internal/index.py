...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor import html5lib, requests, six  # vendor:skip
else:
  from pex.third_party.pip._vendor import html5lib, requests, six

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.distlib.compat import unescape  # vendor:skip
else:
  from pex.third_party.pip._vendor.distlib.compat import unescape

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.packaging import specifiers  # vendor:skip
else:
  from pex.third_party.pip._vendor.packaging import specifiers
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._vendor.requests.exceptions import HTTPError, RetryError, SSLError  # vendor:skip
else:
  from pex.third_party.pip._vendor.requests.exceptions import HTTPError, RetryError, SSLError
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.download import is_url, url_to_path  # vendor:skip
else:
  from pex.third_party.pip._internal.download import is_url, url_to_path
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  ...
  from pex.third_party.pip._internal.exceptions import (
    BestVersionAlreadyInstalled, DistributionNotFound, InvalidWheelFilename,
    UnsupportedWheel,
)

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.models.candidate import InstallationCandidate  # vendor:skip
else:
  from pex.third_party.pip._internal.models.candidate import InstallationCandidate

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.models.format_control import FormatControl  # vendor:skip
else:
  from pex.third_party.pip._internal.models.format_control import FormatControl
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.models.selection_prefs import SelectionPreferences  # vendor:skip
else:
  from pex.third_party.pip._internal.models.selection_prefs import SelectionPreferences

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.models.target_python import TargetPython  # vendor:skip
else:
  from pex.third_party.pip._internal.models.target_python import TargetPython

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.compat import ipaddress  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.compat import ipaddress
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.packaging import check_requires_python  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.packaging import check_requires_python
...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.wheel import Wheel  # vendor:skip
else:
  from pex.third_party.pip._internal.wheel import Wheel
...
if MYPY_CHECK_RUNNING:
    ...
    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._vendor.requests import Response  # vendor:skip
    else:
      from pex.third_party.pip._vendor.requests import Response

    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.models.search_scope import SearchScope  # vendor:skip
    else:
      from pex.third_party.pip._internal.models.search_scope import SearchScope

    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.req import InstallRequirement  # vendor:skip
    else:
      from pex.third_party.pip._internal.req import InstallRequirement

    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.download import PipSession  # vendor:skip
    else:
      from pex.third_party.pip._internal.download import PipSession

    if "__PEX_UNVENDORED__" in __import__("os").environ:
      from pip._internal.pep425tags import Pep425Tag  # vendor:skip
    else:
      from pex.third_party.pip._internal.pep425tags import Pep425Tag
