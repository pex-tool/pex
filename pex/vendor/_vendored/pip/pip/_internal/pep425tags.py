...
if "__PEX_UNVENDORED__" in __import__("os").environ:
  import pip._internal.utils.glibc  # vendor:skip
else:
  import pex.third_party.pip._internal.utils.glibc, pex.third_party.pip as pip

if "__PEX_UNVENDORED__" in __import__("os").environ:
  from pip._internal.utils.compat import get_extension_suffixes  # vendor:skip
else:
  from pex.third_party.pip._internal.utils.compat import get_extension_suffixes
