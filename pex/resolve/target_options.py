...
def register(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "a CPython interpreter, `CPython_t` for a free-threaded CPython interpreter and "
            "`PyPy` for a PyPy interpreter. This argument may be repeated multiple times to OR "
