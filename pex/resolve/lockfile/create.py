...
def create(
    ...
    lock = Lockfile.create(
        ...
        allow_prereleases=pip_configuration.allow_prereleases,
        allow_wheels=pip_configuration.build_configuration.allow_wheels,
        only_wheels=pip_configuration.build_configuration.only_wheels,
        allow_builds=pip_configuration.build_configuration.allow_builds,
        only_builds=pip_configuration.build_configuration.only_builds,
        prefer_older_binary=pip_configuration.build_configuration.prefer_older_binary,
        use_pep517=pip_configuration.build_configuration.use_pep517,
        build_isolation=pip_configuration.build_configuration.build_isolation,
        transitive=pip_configuration.transitive,
