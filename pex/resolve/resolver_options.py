...
def register(
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "https://peps.python.org/pep-0517) or force direct invocation of"
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "dependencies specified by PEP 518 (https://peps.python.org/pep-0518) must "
...
def configure(
    ...
    :param compress: `False` to create wheel zips without compression.
    ...
    pip_configuration = create_pip_configuration(
        options, use_system_time=use_system_time, compress=compress, honor_editable=honor_editable
    )
